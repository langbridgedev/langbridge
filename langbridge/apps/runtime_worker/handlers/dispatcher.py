...
class WorkerMessageDispatcher:
    ...
    def __resolve_handlers(
        ...
        # Import runtime-owned handler modules so BaseMessageHandler subclasses are registered.
        from .jobs.connector_sync_job_request_handler import ConnectorSyncJobRequestHandler  # noqa: F401
