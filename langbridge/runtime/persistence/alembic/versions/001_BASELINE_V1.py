...
def upgrade() -> None:
    ...
    sa.Column('runtime_pool_id', sa.String(length=255), nullable=True),
    ...
    op.create_index(op.f('ix_jobs_actor_id'), 'jobs', ['actor_id'], unique=False)
    op.create_index(op.f('ix_jobs_affinity_key'), 'jobs', ['affinity_key'], unique=False)
    op.create_index(op.f('ix_jobs_concurrency_key'), 'jobs', ['concurrency_key'], unique=False)
    ...
    op.create_index('ix_jobs_runnable', 'jobs', ['status', 'scheduled_at', 'locked_until', 'priority', 'created_at'], unique=False)
    op.create_index(op.f('ix_jobs_runtime_pool_id'), 'jobs', ['runtime_pool_id'], unique=False)
    ...
    op.create_index('ix_jobs_workspace_subject_status', 'jobs', ['workspace_id', 'subject_type', 'subject_id', 'status'], unique=False)
    op.create_index('ix_jobs_workspace_type_status', 'jobs', ['workspace_id', 'job_type', 'status', 'created_at'], unique=False)
    ...
    sa.Column('attempt', sa.Integer(), nullable=False),
    sa.Column('max_attempts', sa.Integer(), nullable=False),
    sa.Column('resume_policy', sa.String(length=64), nullable=True),
    sa.Column('reuse_policy', sa.String(length=64), nullable=True),
    sa.Column('input', sa.JSON(), nullable=False),
    sa.Column('state', sa.JSON(), nullable=False),
    sa.Column('result', sa.JSON(), nullable=True),
    sa.Column('error', sa.JSON(), nullable=True),
    sa.Column('diagnostics', sa.JSON(), nullable=False),
    sa.Column('started_sequence', sa.BigInteger(), nullable=True),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('job_id', 'task_key', name='uq_job_tasks_job_task_key')
    )
    op.create_index(op.f('ix_job_tasks_job_id'), 'job_tasks', ['job_id'], unique=False)
    op.create_index('ix_job_tasks_job_status', 'job_tasks', ['job_id', 'status', 'updated_at'], unique=False)
    op.create_index(op.f('ix_job_tasks_status'), 'job_tasks', ['status'], unique=False)
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['job_id'], ['jobs.id'], ondelete='cascade'),
    sa.ForeignKeyConstraint(['task_id'], ['job_tasks.id'], ondelete='set null'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('job_id', 'artifact_key', name='uq_job_artifacts_job_key')
    )
    op.create_index(op.f('ix_job_artifacts_artifact_type'), 'job_artifacts', ['artifact_type'], unique=False)
    op.create_index(op.f('ix_job_artifacts_created_at'), 'job_artifacts', ['created_at'], unique=False)
    op.create_index(op.f('ix_job_artifacts_job_id'), 'job_artifacts', ['job_id'], unique=False)
    op.create_index('ix_job_artifacts_job_type', 'job_artifacts', ['job_id', 'artifact_type', 'created_at'], unique=False)
    op.create_index(op.f('ix_job_artifacts_task_id'), 'job_artifacts', ['task_id'], unique=False)
    ...
    sa.Column('raw_event_type', sa.String(length=255), nullable=True),
    ...
    op.create_index(op.f('ix_job_events_task_id'), 'job_events', ['task_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_job_events_task_id'), table_name='job_events')
    ...
    op.drop_index(op.f('ix_job_artifacts_task_id'), table_name='job_artifacts')
    ...
    op.drop_index(op.f('ix_job_artifacts_created_at'), table_name='job_artifacts')
    op.drop_index(op.f('ix_job_artifacts_artifact_type'), table_name='job_artifacts')
    ...
    op.drop_index(op.f('ix_job_tasks_status'), table_name='job_tasks')
    ...
    op.drop_index('ix_jobs_workspace_type_status', table_name='jobs')
    op.drop_index('ix_jobs_workspace_subject_status', table_name='jobs')
    ...
    op.drop_index(op.f('ix_jobs_runtime_pool_id'), table_name='jobs')
    ...
    op.drop_index(op.f('ix_jobs_concurrency_key'), table_name='jobs')
    op.drop_index(op.f('ix_jobs_affinity_key'), table_name='jobs')
    op.drop_index(op.f('ix_jobs_actor_id'), table_name='jobs')
    op.drop_table('jobs')
